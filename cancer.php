                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="error-info">
                            <h1 class="mb-30">:(</h1>
                            <span class="error-sub">Próximamente</span>

                            <p>Visítanos próximamente para conocer más sobre esta enfermedad</p>
                            <a class="btn btn-lg waves-effect waves-light" href="index.php">Inicio</a>
                        </div>
                    </div>
                </div>
            </div>
