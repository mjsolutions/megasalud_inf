  ...
  <section class="padding-top-110 mb-100">
    <div class="container">
      ...
      <div class="text-center mb-50 wow fadeInUp" data-wow-delay=".2s">
        <h2 class="section-title">¿Cómo mejorar mi alimentación?</h2>
      </div>
      ...
      <div class="row">
        <div class="col-md-7 wow fadeInRight" data-wow-delay=".3s">
          ...
          <ul>
            ...
            <li><i class="material-icons left txt-blue">&#xE5CA;</i> Los alimentos plásticos contribuyen a la formación de los tejidos, al crecimiento y desarrollo del organismo. Son ricos en proteínas. Ej.: leche, queso, huevo, carne. </li>
            <li><i class="material-icons left txt-blue">&#xE5CA;</i> Los alimentos reguladores permiten que se realicen de manera correcta todas las funciones del organismo. Son ricos en vitaminas, minerales y agua. Ej.: frutas y verduras </li>
          </ul>
        </div><!-- /.col-md-7 -->

        <div class="col-md-5 wow fadeInLeft" data-wow-delay=".3s">
          <div class="hero-thumb">
            <img src="assets/img/megasalud/img2.jpg" class="img-responsive">            
          </div><!-- /.gallery-thumb -->
        </div><!-- /.col-md-5 -->
    ...
    <div class="container mt-30">
      <div class="row">
        ...
        <div class="col-md-5 wow fadeInRight" data-wow-delay=".3s">
          <div class="hero-thumb">
            <img src="assets/img/megasalud/img1.jpeg" class="img-responsive">            
          </div><!-- /.gallery-thumb -->
        </div><!-- /.col-md-5 -->
