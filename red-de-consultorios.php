...
<head>
  ...
  <title>Red de Consultorios</title>
  ...
  <section class="section-padding">
    <div class="container">
      ...
      <div class="text-center mb-80 wow fadeInUp" data-wow-delay=".2s">
        <h2 class="section-title">Megasalud cerca de ti</h2>
        <p class="section-sub">Si vives en otra ciudad de la República Mexicana, contáctanos para saber si tendremos nuestra Caravana de Salud en tu ciudad.</p>
      </div>
