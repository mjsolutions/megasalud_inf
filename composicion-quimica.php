...
<head>
  ...
  <section class="page-title parallax-bg page-title-bg overlay dark-5 padding-top-140 padding-bottom-150" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="white-text">COMPOSICIÓN QUÍMICA</h2>
          <span class="white-text">Ganoderma Lucidum</span>
          <ol class="breadcrumb">
            <li><a href="index.php">Home</a></li>
            <!-- <li><a href="#">Shortcodes</a></li> -->
            <li class="active">Composición química</li>
          </ol>
        </div>
      </div>
    </div>
  ...
  <section class="padding-top-100 mb-50">
    ...
    <div class="container">
      ...
      <div class="text-center mb-50 wow fadeInUp" data-wow-delay=".2s">
        <h2 class="section-title">Composición química del Ganoderma Lucidum</h2>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 wow fadeInRight" data-wow-delay=".3s">
          <div class="hero-thumb">
            <img src="assets/img/megasalud/img11.jpg" class="img-responsive">            
          </div><!-- /.gallery-thumb -->
        </div><!-- /.col-md-5 -->
